    ...
    return (
        <div className='bg-gray-100'>
            <div className="mx-5 rounded-[32px] bg-primPink grid gap-10 justify-center pt-32 pb-40 md:pb-64 px-5 relative bottom-16">
                ...
                <button className="font-bold text-lg md:text-xl text-primPink bg-white rounded-full px-5 py-3 mx-auto border-2 border-white hover:bg-transparent hover:border-2 hover:border-white hover:text-white transition-colors">Shop Now</button>
            </div>
            <div className='mx-10'>
